...
app.post('/signup', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userSignupResponse = yield PgClient.query(userSignupQuery, userSignupParameters);
        const user_id = userSignupResponse.rows[0].id;
        const addressParameters = [city, country, street, pincode, user_id];
        const addressResponse = yield PgClient.query(addressQuery, addressParameters);
...
app.get('/metadata', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const QueryResponse = yield PgClient.query(Query, QueryParameter);
    res.json({
        user: QueryResponse.rows,
    });
}));
//left join
app.get('/leftmetadata', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.query.id;
